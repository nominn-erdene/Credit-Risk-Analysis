...
required_packages <- c("caret", "pROC", "e1071", "PRROC", "Cairo", "knitr")
...
Ложистик регресс ба Гэнэн Байесын алгоритм загваруудын гүйцэтгэлийг харьцуулна.
...
model_comparison <- data.frame(
  "Загвар" = c("Ложистик регресс", "Гэнэн Байес"),
  "Нарийвчлал (%)" = c(logistic_metrics[1], nb_metrics[1]),
  "AUC-ROC" = c(
  ...
  "R² / McFadden R²" = c(logistic_metrics[6], nb_metrics[6])
)
...
conclusion <- append(conclusion,
  sprintf(
    r"(Ложистик регресс ба Гэнэн Байесын алгоритм загварууд зээлийн эрсдэлийг таамаглахад test set дээр
    тус тус %.2f%% (AUC=%.4f) ба %.2f%% (AUC=%.4f) нарийвчлалтай байна. 
...
knitr::kable(
  prediction_table,
  col.names = c("Зээлийн хэмжээ", "Хугацаа (сар)", "Нас", "Ложистик регресс (магадлал)", "Гэнэн Байес")
)
```
...
Ложистик регрессийн загвар нь Гэнэн Байесын алгоритмаас илүү сайн гүйцэтгэл үзүүлсэн. Ложистик регресс нь 74.33% нарийвчлал, 0.7987 AUC-ROC утгатай байхад, Гэнэн Байес нь 67.00% нарийвчлал, 0.7784 AUC-ROC утгатай байна. Ложистик регресс нь илүү сайн Precision (0.5496) үзүүлсэн бөгөөд энэ нь эрсдэлтэй гэж таамагласан зээлдэгчдийн дунд бодитоор эрсдэлтэй байх хувь их байгааг илтгэж байна. Гэнэн Байесын алгоритм нь илүү сайн Recall (0.9000) үзүүлсэн бөгөөд энэ нь бодит эрсдэлтэй зээлдэгчдийг илүү сайн олж илрүүлж байгааг харуулж байна.
...
3. **Загваруудын тоо:** Ложистик регресс ба Гэнэн Байесын алгоритм зөвхөн хоёр загварыг авч үзсэн.
