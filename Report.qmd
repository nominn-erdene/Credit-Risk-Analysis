...
team_members <- data.frame(
  ...
  "Үүрэг, оролцоо" = c(
    "Өгөгдөл бэлтгэл/EDA – өгөгдлийг татаж цэвэрлэсэн, хувьсагчдын давтамж, корреляци, үндсэн статистикийг гаргасан.",
    "Харагдац, тайлан – Quarto тайланг эмхэтгэсэн, тархалтын график, ROC/PR зургийг бэлтгэсэн, ишлэл ба формат зохион байгуулсан.",
    "Загварчлал ба үнэлгээ – логистик, гэнэн Байес загварыг кодлон ажиллуулсан, train/test хуваалт, метрикүүд (AUC, Precision/Recall/F1) болон графикуудыг бэлтгэсэн, дүгнэлтэд тусалсан.",
    "Жишээ таамаглал ба хязгаарлалт – шинэ зээлдэгчийн таамаглалын хэсгийг хийсэн, хязгаарлалт/ирээдүйн ажлын хэсгийг бичсэн, эх сурвалжийн тоймд оролцсон.",
    "Төслийн ахлагч – хүрээг тодорхойлж зохион байгуулсан, өгөгдлийн урсгалыг цэвэрлэсэн, загвар сонголт/нарийвчлал сайжруулалт хийсэн, арга зүй ба үр дүнгийн бичилтэд голлон оролцсон."
  ),
  stringsAsFactors = FALSE
)
...
# LaTeX хүснэгтэд баганын өргөнийг тохируулах
team_table <- knitr::kable(
  team_members, 
  col.names = c("Гишүүний нэр", "ID", "Үүрэг, оролцоо, хувь нэмэр"),
  format = "latex",
  booktabs = TRUE,
  linesep = "",
  align = c("p{3.3cm}", "p{2.4cm}", "p{9.5cm}")
)
