...
Энэхүү төсөл нь UCI-ийн German Credit dataset дээр borrower-level мэдээлэл ашиглан зээлийн чанарыг (good/bad) логистик регрессээр үнэлж, high/low risk ангиллыг гаргах зорилготой.

**Гол зорилго:**
- Зээлийн эрсдэлийг borrower-level мэдээллээр тодорхойлох
- Логистик регресс зэрэг магадлалын загвараар bad credit магадлал тооцох
- AUC, confusion matrix зэрэг үзүүлэлтээр загварын гүйцэтгэлийг шалгах
...
3. **Багцууд суулгах:**
   ```r
   install.packages(c("Cairo", "knitr"))
   ```
...
- Өгөгдлийн цэвэрлэгээ, borrower-level бэлтгэл

### 2. Зээлийн эрсдэлийн үндсэн статистик
- Good/bad кредитийн хувь, дундаж хэмжээ, хугацаа, нас

### 3. Логистик регрессээр эрсдэлийн үнэлгээ
- Train/test split (70/30)
- Коэффициентуудын тайлбар, үндсэн драйверууд
...
1. **Логистик регресс (`glm(family = binomial)`)**
2. **Гүйцэтгэлийн үзүүлэлтүүд:** confusion matrix, precision/recall, accuracy, AUC (гараар тооцсон)
